            ...
            <form action="{{ route('admin.shipping.update', ['shipping' => $shippingMethod->shipping_methods_id]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="courier" id="courier" 
                           ...
                           value="{{ old('courier', $shippingMethod->courier) }}" required>
                    @error('courier')
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="courier_service" id="courier_service" 
                           ...
                           value="{{ old('courier_service', $shippingMethod->courier_service) }}" required>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="delivery_estimate" id="delivery_estimate" 
                           ...
                           value="{{ old('delivery_estimate', $shippingMethod->delivery_estimate) }}" required>
